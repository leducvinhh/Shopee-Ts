export default function AppError() {
  return (
    <main className='flex h-screen w-full flex-col items-center justify-center'>
      <h1 className='text-9xl font-extrabold tracking-widest text-gray-900'>SOS</h1>
      <div className='absolute rotate-12 rounded bg-orange px-2 text-sm'>Something went wrong. </div>
